...
apt-get install -y libffi-dev gfortran gfortran-8 libarpack2 libarpack2-dev   \
       ...
       libgmp3-dev libgmp-dev lib64readline-dev cmake                         \
       ...
       libtinfo-dev libtexttools6-dev libncurses5-dev lib64ncurses5-dev       \
       libqdbm-dev libgdbm-dev libsqlite3-dev jq libbz2-dev zlib1g-dev        \
       libncurses-dev make libzmq3-dev sbcl texinfo
